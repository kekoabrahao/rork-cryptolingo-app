type AnalyticsEvent = 
  ...
  | 'lz_chat_history_cleared_by_user'
  | 'lz_chat_conversation_updated'
  | 'lz_chat_api_error'
  | 'lz_chat_send_failed'
  | 'lz_chat_load_history_failed'
  | 'lz_chat_save_history_failed'
  | 'lz_chat_clear_failed'
  | 'lz_chat_limit_check_failed'
